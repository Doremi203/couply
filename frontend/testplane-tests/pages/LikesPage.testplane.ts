describe('LikesPage Component', () => {
  it('should match the reference screenshot', async ({ browser }) => {
    // Set window size to ensure consistent screenshots
    await browser.setWindowSize(1920, 1080);
    
    // Navigate to the Storybook page for the LikesPage component
    await browser.url('http://localhost:6006/?path=/story/pages-likespage--default');
