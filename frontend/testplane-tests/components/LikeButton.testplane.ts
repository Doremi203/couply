describe('LikeButton Component', () => {
  it('should match the reference screenshot for default variant', async ({ browser }) => {
    ...
    // Navigate to the Storybook page for the LikeButton component
    await browser.url('http://localhost:6006/?path=/story/shared-likebutton--default');
  ...
  it('should match the reference screenshot for custom class variant', async ({ browser }) => {
    ...
    // Navigate to the Storybook page for the LikeButton component with custom class
    await browser.url('http://localhost:6006/?path=/story/shared-likebutton--with-custom-class');
