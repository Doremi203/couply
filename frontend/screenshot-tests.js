...
//   { name: 'ButtonWithIcon', url: '/?path=/story/components-buttonwithicon--default' },
//   { name: 'Dislike', url: '/?path=/story/components-dislike--default' },
//   { name: 'FiltersIcon', url: '/?path=/story/components-filtersicon--default' },
//   { name: 'Like', url: '/?path=/story/components-like--default' },
...
//   { name: 'ChatPage', url: '/?path=/story/pages-chatpage--default' },
//   { name: 'LikesPage', url: '/?path=/story/pages-likespage--default' },
//   { name: 'ProfilePage', url: '/?path=/story/pages-profilepage--default' },
//   { name: 'SplashPage', url: '/?path=/story/pages-splashpage--default' },
// ];
