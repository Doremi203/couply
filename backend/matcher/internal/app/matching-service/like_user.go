...
func (i *Implementation) LikeUserV1(ctx context.Context, in *desc.LikeUserV1Request) (*desc.LikeUserV1Response, error) {
	...
	case errors.Is(err, matching.ErrMatchExistsBetweenTheseUsers):
		return nil, status.Error(codes.FailedPrecondition, matching.ErrMatchExistsBetweenTheseUsers.Error())
	case err != nil:
		return nil, err
	}
