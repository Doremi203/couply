...
func (p *providerStub) GenerateV7() (uuid.UUID, error) {
...
func TestUseCase_UpdateUser(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			setup: func(m mocks) {
				m.photoURLGenerator.EXPECT().GenerateUpload(
					gomock.Any(),
					"users/11111111-1111-1111-1111-111111111111/slot/0/11111111-1111-1111-1111-111111111111.jpg",
					".jpg",
